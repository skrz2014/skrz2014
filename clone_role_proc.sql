...
BEGIN
    ...
    SELECT EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROLES WHERE ROLE_NAME = :P_SOURCE_ROLE_NAME AND DELETED_ON IS NULL) INTO V_SOURCE_ROLE_EXISTS;
    ...
    SELECT EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.ROLES WHERE ROLE_NAME = :P_TARGET_ROLE_NAME AND DELETED_ON IS NULL) INTO V_TARGET_ROLE_EXISTS;

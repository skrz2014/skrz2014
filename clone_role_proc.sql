...
BEGIN
    ...
    SHOW ROLES LIKE :P_SOURCE_ROLE_NAME;
    SELECT COUNT(*) > 0 INTO V_SOURCE_ROLE_EXISTS FROM TABLE(RESULT_SCAN(LAST_QUERY_ID())) WHERE "name" = :P_SOURCE_ROLE_NAME;
    ...
    SHOW ROLES LIKE :P_TARGET_ROLE_NAME;
    SELECT COUNT(*) > 0 INTO V_TARGET_ROLE_EXISTS FROM TABLE(RESULT_SCAN(LAST_QUERY_ID())) WHERE "name" = :P_TARGET_ROLE_NAME;
